    ...
    <div>
        <div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" v-model="name" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <button @click="EnterRoom" type="submit" class="btn btn-primary">Submit</button>
        </div>
        <div>
            <div class="card" style="width: 18rem;" v-for="(name,index) in names" :key="index" :name="name">
                <div class="card-body">
